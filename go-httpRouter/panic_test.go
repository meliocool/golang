...
// * Panic Handler
// * When Panic happens, there will be and error, and web will stop sending response
// * In regular Go, we need to create a middleware, but in httprouter there is a built in PanicHandler
